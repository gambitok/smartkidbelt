...
class PHPMailer{
    ...
    public $ErrorInfo = '';
    public $From = 'smartkidbeltukraine@gmail.com';
    public $FromName = 'Smart Kid Belt Ukraine';
    public $Sender = '';
    public $ReturnPath = '';
    public $Subject = '';
    public $Body = '';
    ...
    public $Username = 'smartkidbeltukraine@gmail.com';
	public $Password = "Qwerty456852z";
    public $AuthType = '';
    public $Realm = '';
    public $Workstation = '';
    public $Timeout = 15;
